 ...
 */
export function inferType(value, fieldName) {
    // Handle null
    if (value === null) {
        return { kind: 'null' };
    }
 ...
 */
export function inferTypeFromExamples(examples) {
    ...
    if (allAreObjects) {
        return mergeObjectTypeDefinitions(allTypes.filter(t => t.kind === 'object'));
    }
 ...
 */
function mergeObjectTypeDefinitions(types) {
