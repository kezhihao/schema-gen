 ...
 */
export function generateApiDoc(options: GenerateOptions): string {
 ...
 */
function getTypeDisplayName(typeDef: TypeDefinition): string {
  switch (typeDef.kind) {
    case 'string':
      return 'string';
    case 'number':
 ...
 */
function getTypeDescription(typeDef: TypeDefinition): string {
 ...
 */
function generateExample(typeDef: TypeDefinition, indent = 0): string {
